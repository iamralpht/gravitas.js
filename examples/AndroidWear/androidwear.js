...
function AndroidWearDemo(element) {
    ...
    function Watch(useCSS) {
        ...
        //
        this._acceptSimulation = new Gravitas.Gravity(1000, 280);
        this._cancelSimulation = new Gravitas.Spring(1, 400, 40); // Critically damped cancellation spring.
    ...
    Watch.prototype.onTouchEnd = function(dx, dy, velocity) {
        ...
        if (end > 0) {
            ...
            this._animation = Gravitas.createAnimation(this._acceptSimulation, this._update.bind(this, 1, this._acceptSimulation));
        }
        else {
            ...
            this._animation = Gravitas.createAnimation(this._cancelSimulation, this._update.bind(this, 240, this._cancelSimulation));
        }
