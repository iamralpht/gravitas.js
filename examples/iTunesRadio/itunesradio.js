...
// This simulation provides constant velocity, and is pretty simple so
// not yet included in Gravitas proper.
...
function iTunesRadioDemo(element) {
    ...
    this._startOffset = 0;
    this._friction = new Gravitas.Friction(0.001);
    ...
    this._animation = Gravitas.createAnimation(this._constantVelocity, this._update.bind(this));
}
